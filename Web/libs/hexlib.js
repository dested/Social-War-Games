...
// window for node/browserify modules:

window.Point = Point;

window.Hex = Hex;
window.hex_add = hex_add;
window.hex_subtract = hex_subtract;
window.hex_scale = hex_scale;
window.hex_directions = hex_directions;
window.hex_direction = hex_direction;
window.hex_neighbor = hex_neighbor;
window.hex_diagonals = hex_diagonals;
window.hex_diagonal_neighbor = hex_diagonal_neighbor;
window.hex_length = hex_length;
window.hex_distance = hex_distance;
window.hex_round = hex_round;
window.hex_lerp = hex_lerp;
window.hex_linedraw = hex_linedraw;

window.OffsetCoord = OffsetCoord;
window.EVEN = EVEN;
window.ODD = ODD;
window.qoffset_from_cube = qoffset_from_cube;
window.qoffset_to_cube = qoffset_to_cube;
window.roffset_from_cube = roffset_from_cube;
window.roffset_to_cube = roffset_to_cube;

window.Orientation = Orientation;

window.Layout = Layout;
window.layout_pointy = layout_pointy;
window.layout_flat = layout_flat;
window.hex_to_pixel = hex_to_pixel;
window.pixel_to_hex = pixel_to_hex;
window.hex_corner_offset = hex_corner_offset;
window.polygon_corners = polygon_corners;
